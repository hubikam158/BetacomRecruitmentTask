...
public class Descriptions {
    ...
    public static final String REGISTERING = "Register to the platform.";
    public static final String AUTHENTICATING = "Authenticate with the platform.";
    public static final String ITEM_CREATING = "Create a new item.";
    public static final String ITEM_GETTING = "Get a list of current user's items.";
}
